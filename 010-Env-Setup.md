...
## Table of Contents
- [1. Access the VSCode instance](#1-skip-to-in-aws-event-access-the-vscode-instance)
...
- [4. Adding prompts to SAM](#4-adding-prompts-to-sam)
- [Next Steps](#next-steps)

## 1. Access the VSCode instance: if in AWS Event skip to [Installing Solace Agent Mesh](#2-installing-solace-agent-mesh)
